...
<html lang="en">
  ...
  <body data-spy="scroll" data-target="#navbar" data-offset="57">
    ...
    <section id="conviertete-en-orador" class="pt-3 pb-3">
        ...
        <div class="row">
          <div class="col col-md-12 offset-md-1 col-lg-12 offset-lg-3 pt-2 mr-2">
            <form action="actualizar.php" method="POST">
              <div class="form-row">
                ...
                <div class="form-group col-12">
                  <input type="text" class="form-control" name="tema" placeholder="Tema" value="<?php echo $fila['tema'];?>">
                </div>
